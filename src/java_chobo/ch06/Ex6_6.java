...
public class Ex6_6 {
	...
	public static void main(String[] args) {
		...
		System.out.printf("c1.WIDTH = %d%n", Card.WIDTH);
		System.out.printf("c1.HEIGHT = %d%n", Card.HEIGHT);
		
		System.out.printf("c2.WIDTH = %d%n", Card.WIDTH);
		System.out.printf("c2.HEIGHT = %d%n", Card.HEIGHT);
